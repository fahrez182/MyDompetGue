                ...
                <div class="p-5 sm:p-6">
                    ...
                    <form method="POST" action="{{ route('categories.update', $category) }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1.5 w-full bg-[#11141d] border-gray-700 text-white text-xs focus:border-[#3b82f6] focus:ring-[#3b82f6] rounded-xl px-3 py-2 shadow-sm focus:outline-none" type="text" name="name" :value="old('name', $category->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="block mt-1.5 w-full bg-[#11141d] border-gray-700 text-white text-xs focus:border-[#3b82f6] focus:ring-[#3b82f6] rounded-xl px-3 py-2 shadow-sm focus:outline-none" required>
                                <option value="income" {{ old('type', $category->type) == 'income' ? 'selected' : '' }} class="bg-[#0f172a]">{{ __('Income') }}</option>
                                <option value="expense" {{ old('type', $category->type) == 'expense' ? 'selected' : '' }} class="bg-[#0f172a]">{{ __('Expense') }}</option>
                            </select>
