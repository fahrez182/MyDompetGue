                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('transactions.update', $transaction) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="amount" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700" type="number" step="0.01" name="amount" :value="old('amount', $transaction->amount)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="transaction_date" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700" type="date" name="transaction_date" :value="old('transaction_date', $transaction->transaction_date->format('Y-m-d'))" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea id="description" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700" name="description">{{ old('description', $transaction->description) }}</x-textarea>
