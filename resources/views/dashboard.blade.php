<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-green-100 dark:bg-green-800 p-4 rounded-lg shadow">
                            ...
                            <p class="text-2xl font-bold text-green-900 dark:text-green-50">Rp {{ number_format($totalIncome, 2, ',', '.') }}</p>
                        </div>
                        <div class="bg-red-100 dark:bg-red-800 p-4 rounded-lg shadow">
                            ...
                            <p class="text-2xl font-bold text-red-900 dark:text-red-50">Rp {{ number_format($totalExpense, 2, ',', '.') }}</p>
                        </div>
                        <div class="bg-blue-100 dark:bg-blue-800 p-4 rounded-lg shadow">
                            ...
                            <p class="text-2xl font-bold text-blue-900 dark:text-blue-50">Rp {{ number_format($balance, 2, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Monthly Overview</h3>
